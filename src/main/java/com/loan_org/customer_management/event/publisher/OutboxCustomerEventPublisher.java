...
import com.loan_org.customer_management.event.config.RabbitMQConfig;
...
public class OutboxCustomerEventPublisher implements CustomerEventPublisher {
    ...
    public void publishCustomerCreated(
        ...
        CustomerEvent<CustomerCreatedEvent> event =
                createEvent(
                        "CUSTOMER_CREATED",
                        customer,
                        data
        ...
        saveToOutbox(
                event,
                RabbitMQConfig.CUSTOMER_CREATED
        );
    }
    ...
    public void publishCustomerUpdated(
        ...
        CustomerEvent<CustomerUpdatedEvent> event =
                createEvent(
                        "CUSTOMER_UPDATED",
                        customer,
                        data
        ...
        saveToOutbox(
                event,
                RabbitMQConfig.CUSTOMER_UPDATED
        );
    }


    @Override
    public void publishCustomerStatusChanged(
            CustomerDocument customer,
        ...
        CustomerEvent<CustomerStatusChangedEvent> event =
                createEvent(
        ...
        saveToOutbox(
                event,
                RabbitMQConfig.CUSTOMER_STATUS_CHANGED
        );
    }


    @Override
    public void publishCustomerAddressChanged(
            CustomerDocument customer,
            String addressId,
            String changeType
    ) {
        ...
        CustomerEvent<CustomerAddressChangedEvent> event =
                createEvent(
        ...
        saveToOutbox(
                event,
                RabbitMQConfig.CUSTOMER_ADDRESS_CHANGED
        );
    }


    @Override
    public void publishCustomerIdentificationChanged(
            CustomerDocument customer,
        ...
        CustomerEvent<CustomerIdentificationChangedEvent> event =
                createEvent(
        ...
        saveToOutbox(
                event,
                RabbitMQConfig.CUSTOMER_IDENTIFICATION_CHANGED
        );
    }


    private <T> CustomerEvent<T> createEvent(
            String eventType,
            CustomerDocument customer,
            T data
    ) {
