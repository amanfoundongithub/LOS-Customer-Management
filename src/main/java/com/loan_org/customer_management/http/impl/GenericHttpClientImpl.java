...
public class GenericHttpClientImpl implements GenericHttpClient {
    ...
    /**
     * GET supporting generic response types such as:
     *
     * List<PincodeApiResponse>
     */
    @Override
    public <T> T get(
            String url,
    ...
    /**
     * GET supporting generic response types and custom headers.
     */
    @Override
    public <T> T get(
            String url,
    ...
    // =========================================================================
    // GENERIC EXCHANGE - CLASS<T>
    // =========================================================================

    public <R, T> T exchange(
            HttpMethod method,
            String url,
            R requestBody,
            HttpHeaders headers,
    ...
    // =========================================================================
    // GENERIC EXCHANGE - PARAMETERIZED TYPE
    // =========================================================================
    ...
    private <R> RestClient.RequestBodySpec createRequest(
            HttpMethod method,
            String url,
            R requestBody,
            HttpHeaders headers
